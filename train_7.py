...
def train(
    ...
    FusionNet = FusionNet.to(device=nn_handler_device)
    ...
    for iE in range(n_epochs):
        ...
        for iB, batch in enumerate(dataloader):
            ...
            if amp:
                ...
                prediction = y.detach().to('cpu').numpy()
                np.save('/mnt/sdg/maxs/results/LIVECell/array_eval_after.npy', prediction)
